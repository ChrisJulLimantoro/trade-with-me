    ...
    *,
    ...
    for candle in candles:
        ...
        step = step_trade(
            ...
            breakeven_arm_harvest_frac=settings.exits.breakeven_arm_harvest_frac,
            breakeven_arm_harvest2_frac=settings.exits.breakeven_arm_harvest2_frac,
            breakeven_arm_harvest2_atr=settings.exits.breakeven_arm_harvest2_atr,
            pre_arm_harvest_frac=settings.exits.pre_arm_harvest_frac,
            pre_arm_harvest_atr=settings.exits.pre_arm_harvest_atr,
            pre_arm_giveback_frac=settings.exits.pre_arm_giveback_frac,
            pre_arm_giveback_trigger_atr=settings.exits.pre_arm_giveback_trigger_atr,
            pre_arm_giveback_retrace_atr=settings.exits.pre_arm_giveback_retrace_atr,
            tp_runner_frac=settings.exits.tp_runner_frac,
